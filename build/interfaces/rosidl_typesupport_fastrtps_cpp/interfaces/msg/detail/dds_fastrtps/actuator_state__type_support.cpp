...
#include "interfaces/msg/detail/actuator_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::ActuatorState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::ActuatorState & ros_message)
{
  // Member: names
  {
    cdr >> ros_message.names;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::ActuatorState;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
max_serialized_size_key_ActuatorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const interfaces::msg::ActuatorState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::ActuatorState *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_ActuatorState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, ActuatorState)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_ActuatorState__handle;
}
