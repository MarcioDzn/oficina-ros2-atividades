...
#include "interfaces/msg/detail/actuator_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::ActuatorCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::ActuatorCommand & ros_message)
{
  // Member: names
  {
    cdr >> ros_message.names;
  ...
  size_t current_alignment)
{
  ...
  // Member: goals
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.goals[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::ActuatorCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::ActuatorCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::ActuatorCommand *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_ActuatorCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, ActuatorCommand)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_ActuatorCommand__handle;
}
