...
#include "interfaces/msg/detail/actuator_state__rosidl_typesupport_fastrtps_c.h"
...
using _ActuatorState__ros_msg_type = interfaces__msg__ActuatorState;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_serialize_interfaces__msg__ActuatorState(
  const interfaces__msg__ActuatorState * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_deserialize_interfaces__msg__ActuatorState(
  eprosima::fastcdr::Cdr & cdr,
  interfaces__msg__ActuatorState * ros_message)
{
  // Field name: names
  {
    uint32_t cdrSize;
  ...
  // Field name: positions
  {
    ...
    if (ros_message->positions.data) {
      rosidl_runtime_c__int16__Sequence__fini(&ros_message->positions);
    }
    if (!rosidl_runtime_c__int16__Sequence__init(&ros_message->positions, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__msg__ActuatorState(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__ActuatorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__ActuatorState;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_serialize_key_interfaces__msg__ActuatorState(
  const interfaces__msg__ActuatorState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: names
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_key_interfaces__msg__ActuatorState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ActuatorState__ros_msg_type * ros_message = static_cast<const _ActuatorState__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_key_interfaces__msg__ActuatorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const interfaces__msg__ActuatorState * ros_message = static_cast<const interfaces__msg__ActuatorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_interfaces__msg__ActuatorState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  interfaces__msg__ActuatorState * ros_message = static_cast<interfaces__msg__ActuatorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_interfaces__msg__ActuatorState(cdr, ros_message);
}

static uint32_t _ActuatorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__ActuatorState(
...
static size_t _ActuatorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__ActuatorState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, ActuatorState)() {
