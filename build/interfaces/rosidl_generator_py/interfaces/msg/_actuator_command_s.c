...
bool interfaces__msg__actuator_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._actuator_command.ActuatorCommand", full_classname_dest, 48) == 0);
  }
  interfaces__msg__ActuatorCommand * ros_message = _ros_message;
  {  // names
  ...
  {  // goals
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int16_t * dest = ros_message->goals.data;
...
PyObject * interfaces__msg__actuator_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._actuator_command");
  ...
  {  // goals
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "goals");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->goals.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int16_t * src = &(ros_message->goals.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->goals.size * sizeof(int16_t));
      assert(data != NULL);
