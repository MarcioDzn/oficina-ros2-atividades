...
class ActuatorState(metaclass=Metaclass_ActuatorState):
    ...
    def __init__(self, **kwargs):
        ...
        self.positions = array.array('h', kwargs.get('positions', []))
        ...
        if self._check_fields:
            if isinstance(value, array.array):
                assert value.typecode == 'h', \
                    "The 'positions' array.array() must have the type code of 'h'"
            ...
            assert \
                ...
                "The 'positions' field must be a set or sequence and each value of type 'int' and each integer in [-32768, 32767]"
        self._positions = array.array('h', value)
