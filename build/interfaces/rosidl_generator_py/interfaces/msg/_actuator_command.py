    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'interfaces.msg.ActuatorCommand')
            logger.debug(
...
class ActuatorCommand(metaclass=Metaclass_ActuatorCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.goals = array.array('h', kwargs.get('goals', []))
        ...
        if self._check_fields:
            if isinstance(value, array.array):
                assert value.typecode == 'h', \
                    "The 'goals' array.array() must have the type code of 'h'"
                self._goals = value
                return
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ...
                "The 'goals' field must be a set or sequence and each value of type 'int' and each integer in [-32768, 32767]"
        self._goals = array.array('h', value)
