...
bool interfaces__msg__actuator_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._actuator_state.ActuatorState", full_classname_dest, 44) == 0);
  }
  interfaces__msg__ActuatorState * ros_message = _ros_message;
  {  // names
  ...
  {  // positions
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int16_t * dest = ros_message->positions.data;
...
PyObject * interfaces__msg__actuator_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._actuator_state");
  ...
  {  // positions
    ...
    if (ros_message->positions.size > 0) {
      ...
      int16_t * src = &(ros_message->positions.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->positions.size * sizeof(int16_t));
      assert(data != NULL);
